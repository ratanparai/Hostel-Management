    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown <?php if($this->checkForActiveAction($filename, "addUser") || $this->checkForActiveAction($filename, 'viewUsers')) {echo "active";} ?>">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="true">Users</a>
                        <ul class="dropdown-menu" role="menu">
                        <li>
                        <a href="<?php echo URL;?>admin/adduser">Add user</a>
                        </li>
                        <li>
                            <a href="<?php echo URL;?>admin/viewusers">View users</a>
                        </li>
                    </ul>
                </li>
                <li class="dropdown <?php if($this->checkForActiveAction($filename, "addNotice")) {echo "active";} ?>">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="true">Notices</a>
                        <ul class="dropdown-menu" role="menu">
                        <li>
                        <a href="<?php echo URL;?>admin/addnotice">Add Notice</a>
                        </li>
                    </ul>
                </li>
            </ul>
