            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  <div class="form-group username">
                    <label for="userid"><i class="glyphicon glyphicon-user"></i> user ID (<i style="font-weight:normal;">Example: C000000</i>)</label>
                    <input id="username" type="text" class="form-control"  placeholder="Enter ID">
                  </div>
                  <div class="form-group email">
                    <label for="email"><i class="glyphicon glyphicon-envelope"></i> Email (<i style="font-weight:normal;">the password will be send to this mail ID</i>)</label>
                    <input id="email" type="email" class="form-control"  placeholder="Enter ID" required="required">
                  </div>
                  <!--
                  ...
                  <div class="form-group usertype">
                    <label for="usertype"><i class="glyphicon glyphicon-chevron-up"></i> User Type</label>
