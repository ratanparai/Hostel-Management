	...
	<div class="carousel-inner" role="listbox">
		<div class="item active">
			<img class="img-responsive"
				src="<?php echo URL;?>public/img/hostel_front_1.jpg" alt=""
				width="100%">
		...
		<div class="item">
			<img class="img-responsive"
				src="<?php echo URL;?>public/img/hostel_front_2.jpg" alt="">
			<div class="carousel-caption"></div>
		</div>
		<div class="item">
			<img class="img-responsive"
				src="<?php echo URL;?>public/img/hostel_front_page.jpg" alt=""
				width="100%">
			<div class="carousel-caption"></div>
		</div>
	</div>
